...
/// Splits seed infections between E and I the way ASPR-flumodels' `doSeed.SEIR`
/// does: proportionally to the relative time spent in each compartment
/// (`latent_period` vs. `infectious_period`), rather than seeding I only.
